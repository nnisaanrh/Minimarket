<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto mt-10 bg-white dark:bg-gray-800 p-7 rounded-lg shadow-lg">
        ...
        <div class="mt-6 w-1/2 ml-10">
            <a href="{{ route('transaksi.create') }}" 
               class=" ml-20 inline-block px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg shadow hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
                Tambah Transaksi
            </a>
            <!-- Tombol Export -->
